...
for i in range(2, 5):
    ...
    for session in sessions:
        ...
        sessionl.append(item(session.Process.name(), slideAdress(session.Process.name())))
...
icon = pystray.Icon(name="name", icon=Image.open("E:\Code\ArduinoMixer\dist\LOGO.png"), title="Mixer", menu=menu1)
